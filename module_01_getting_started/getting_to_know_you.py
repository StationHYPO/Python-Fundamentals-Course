# File: getting_to_know_you.py
# Purpose: A beginner-friendly program that demonstrates basic Python concepts
# including variables, input, and output through an interactive conversation
